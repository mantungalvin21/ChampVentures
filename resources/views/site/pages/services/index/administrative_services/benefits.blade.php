...
@section("meta")
    ...
    <meta name="description" content="Streamlined administrative processes reduce the burden on your staff and improve.." itemprop="description"> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="text text-center">
                            <h1 class="display-4 text-dark mb-5">Benefits of Our Administrative Services</h1>
                        </div>
                    </div>
                </div>
            </div>
