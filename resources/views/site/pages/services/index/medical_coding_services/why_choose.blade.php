...
@section("meta")
    ...
    <meta name="description" content="Expertise: Our team of certified coders brings extensive experience and knowledge in medical coding." itemprop="description"> 
            ...
            <div class="row g-5 align-items-center flex-column-reverse flex-lg-row">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid rounded align-self-end" src="/assets/img/medical_coding/coding12.jpg" alt="">
