...
@section("meta")
	<title>Benefits of Our Coding Services</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta property="type" content="Champ Ventures">
    <meta property="title" content="Benefits of Our Coding Services">
    ...
    <meta name="description" content="Increased Reimbursement: Accurate and detailed coding maximizes your practice’s reimbursement from insurance payors." itemprop="description"> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="text text-center">
                            <h1 class="display-4 text-dark mb-5">Benefits of Our Coding Services</h1>
                        </div>
                    </div>
                </div>
            </div>
