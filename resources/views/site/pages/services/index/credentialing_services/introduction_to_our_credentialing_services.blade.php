...
@section("meta")
	<title>Introduction to Our Credentialing</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta property="type" content="Champ Ventures">
    <meta property="title" content="Introduction to Our Credentialing">
    ...
    <meta name="description" content="In the healthcare industry, credentialing is essential for verifying that medical professionals possess" itemprop="description"> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="text text-center">
                            <h1 class="display-4 text-dark mb-5">Introduction to Our Credentialing Services</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5 align-items-center flex-column-reverse flex-lg-row">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid rounded align-self-end" src="/assets/img/credentialing/hero3.jpg" alt="">
