...
@section("meta")
    ...
    <meta name="description" content="Our team has extensive experience in medical auditing and is well-versed in the latest coding standards." itemprop="description"> 
            ...
            <div class="row g-5 align-items-center flex-column-reverse flex-lg-row">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid rounded align-self-end" src="/assets/img/auditing/hero9.jpg" alt="">
