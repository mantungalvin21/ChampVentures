                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="text text-center">
                            <h1 class="display-4 text-dark mb-5">Benefits of Our Billing Services</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="/assets/img/medical_billing/billing11.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
