...
@section("meta")
	<title>Detailed Billing Services</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta property="type" content="Champ Ventures">
    <meta property="title" content="Detailed Billing Services">
    ...
    <meta name="description" content="To ensure the highest level of accuracy in your medical claims and increase the likelihood of successful first-pass submissions." itemprop="description"> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="text text-center">
                            <h1 class="display-4 text-dark mb-5">Detailed Billing Services.</h1>
                        </div>
                    </div>
                </div>
            </div>
